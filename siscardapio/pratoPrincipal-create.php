...
<html lang="pt-br">
  <head>
    ...
    <title>Prato Principal - Criar</title>
            ...
            <div class="card-body">
              <form action="./acoes_pratosPrincipais.php" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="pratoPrincipal" id="inputPratoPrincipal" class="form-control">
                </div>
                
                <div class="mb-3">
                  <button type="submit" name="create_pratoPrincipal" class="btn btn-primary">Salvar</button>
                </div>
              </form>
            </div>
          </div>

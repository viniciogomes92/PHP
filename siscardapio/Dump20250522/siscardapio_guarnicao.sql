...
CREATE TABLE `guarnicao` (
  `id_guarnicao` int(11) NOT NULL AUTO_INCREMENT,
  `nome_guarnicao` varchar(100) NOT NULL,
...
INSERT INTO `guarnicao` VALUES (1,'Espaguete alho e óleo'),(3,'Farofa'),(4,'Purê de batata'),(6,'Abóbora ao alho');

...
CREATE TABLE `questoes` (
  ...
  `questao` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `data_criacao` date NOT NULL,
  `nip` int(8) NOT NULL,
  `ativa` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'A',
  PRIMARY KEY (`id`),
  KEY `fk_questoes_nip` (`nip`),
  CONSTRAINT `fk_questoes_nip` FOREIGN KEY (`nip`) REFERENCES `usuarios` (`nip`) ON UPDATE CASCADE

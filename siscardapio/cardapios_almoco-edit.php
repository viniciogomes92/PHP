...
function getCardapioById($pdo, $id) {
    $stmt = $pdo->prepare("SELECT * FROM cardapio_almoco WHERE id_cardapio = ?");
    $stmt->execute([$id]);
...
$cardapio = getCardapioById($pdo, $id_cardapio);
...
<head>
    ...
    <title>Editar Cardápio de Almoço</title>
            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <h4>Editar Cardápio de Almoço
                            <div class="float-end">
                                <a href="./cardapios_almoco.php" class="btn btn-danger">Voltar</a>
                            </div>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="acoes_cardapios_almoco.php">
                            ...
                            <div class="row g-3">
                                ...
                                <!-- Botão de Enviar -->
                                <div class="col-12">
                                    <button type="submit" name="update_cardapioAlmoco" class="btn btn-primary">Atualizar Cardápio</button>
                                </div>
                            </div>
                        </form>
                    </div>
